...
Commands:
  ...
  tts-retrieve      Retrieve a previously generated speech record by socket ID
...
TTS-retrieve Flags:
  --socket-id       Socket/session ID of the speech record to retrieve (required)
...
Examples:
  ...
  telnyx-agent tts-retrieve --socket-id <socket_id> --json
`;
